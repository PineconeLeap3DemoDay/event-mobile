  ...
  return (
    <SafeAreaView>
      ...
      <View style={styles.headerSection}>
        <Heading color={isDark ? 'white' : 'black'} h1 title="Та нэвтэрнэ үү" />
        <Heading
          fontWeight="400"
          ...
          h2
          title="Log into the same account you used to buy your tickets."
        />
      </View>
      <ScrollView
        style={{
        ...
        <View style={{gap: responsiveHeight(16)}}>
          <Button
            ...
            selected
            style={{...padding(0, 15, 0, 15), borderRadius: 5}}>
