    ...
    <Layout>
      ...
      <View
        ...
        <Button
          ...
          style={{
            backgroundColor: DoesUserFollowThisCompany ? '#FCEFF8' : '#D22366',
          }}>
          <Heading
            p
            color={DoesUserFollowThisCompany ? '#D22366' : 'white'}
      ...
      <View style={{...padding(0, 48, 0, 0)}}>
        ...
        <Heading
          ...
          h4
          numberOfLines={5}
          title="Манай компани нь 2006 оноос хойш үйл ажиллагаагаа тасралтгүй явуулж байгаа юм. Та хүссэн улсруугаа хямд зардлаар явах боломжийг олгоно. "
        />
      </View>
      <View>
        <Heading
          style={{...padding(0, 24, 0, 0)}}
          h4
          fontFamily="Inter-SemiBold"
          title="Зохион байгуулсан эвэнтүүд"
        />
        <EventList
